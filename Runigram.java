...
/*		System.out.println("================================================================");
	...
	public static Color[][] scaled(Color[][] image, int width, int height) {
		...
		int srcH = image.length, srcW = image[0].length;
		int srcI, srcJ;


		for (int i = 0; i < height; i++){
			for (int j = 0; j < width; j++){
				srcI = (int) ((double) i / height * srcH);
				srcJ = (int) ((double) j / width * srcW);
	...
	public static void morph(Color[][] source, Color[][] target, int n) {
		...
		if (source.length != target.length || source[0].length != target.length){
